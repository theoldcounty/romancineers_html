				...
				<div id="inbox" class="privatemessages">
						...
						<?php
							...
							(
								...
								array("Robert de Niro", "http://1.bp.blogspot.com/_9jGIJwx7ks8/RywV033v6dI/AAAAAAAABjc/BS1tZF10-xQ/s400/Robert+de+Niro.jpg", "test 7", "short test 7",  "long test 7", "lll934", "unread"),
								...
								<div class="swiper-wrapper"><!--swiper-wrapper-->
														...
														<li class="view-message-trigger" data-message-id="<?php echo $value[5];?>">
															<div class="user-data grid-40 mobile-grid-100">
																<div class="user-image grid-50 mobile-grid-50">
																	...
																	<div class="message-status <?php echo $value[6];?>"></div>
									...
									<div class="swiper-slide">
										...
										<!--slide 2-->
											...
											<div data-message-id="<?php echo $value[5];?>" class="private-pane grid-100 mobile-grid-100">
