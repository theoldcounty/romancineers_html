...
<div id="shazam-wrapper" class="regular">
		...
		<form id="date" data-venue-id="<?php echo $_GET["venueId"]; ?>" data-senderUid="<?php echo $_GET["senderUid"]; ?>" data-recepientUid="<?php echo $_GET["recepientUid"]; ?>" action="date" enctype="multipart/form-data" method="post" action="">
