...
{
	$tm=date("Y-m-d H:i:s");
	$c1->query("UPDATE plus_login SET status='ON',tm='$tm' WHERE userid='$_SESSION[userid]'");
	
	echo'<a href=update-profile.php>'.$_SESSION[userid].'</a> | <a href=change-password.php>Change Password</a> | <a href=logout.php>Sign Out</a>';
	$c1->getError();	
}
else
{
...
$c1->query("UPDATE plus_login SET status='OFF' WHERE tm < '$tm'");
$c1->getError();
