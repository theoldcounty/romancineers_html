...
if(isset($todo) and $todo=="post")
{
	...
	$c1->query("SELECT userid FROM plus_signup WHERE userid = '$userid'");	
	...
	{ // if all validations are passed.
		...
		$query=mysql_query("insert into plus_signup(userid,password,email,name,sex,confirm_hash,is_confirmed,enable) values('$userid','$password','$email','$name','$sex','$hash','0','0')");
	}
}
else
{
