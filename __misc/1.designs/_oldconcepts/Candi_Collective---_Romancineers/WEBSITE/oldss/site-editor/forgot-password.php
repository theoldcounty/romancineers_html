...
if(isset($email))
{
	...
	{  
			...
			$c1->query("SELECT email,userid,password FROM plus_signup WHERE plus_signup.email = '$email'");		
			...
			if($c1->query("update plus_signup set password='$newpassword2' where email='$em'"))
			{
