...
if(isset($todo) and $todo=="post")
{
	...
	{ // if all validations are passed.
		...
		echo "<font face='Verdana' size='2' color=green>Welcome, You have successfully signed up<br><br><a href=login.php>Click here to login</a><br></font>";		
			...
			{
				echo "<center><font face='Verdana' size='2' ><b>THANK YOU</b> <br>Your password has been posted to your email address . Please check your mail. </center>";
			}		
	...
	$c1->query("INSERT INTO basics(id, what_is_your_gender) values('$lastid','$sex')");					
